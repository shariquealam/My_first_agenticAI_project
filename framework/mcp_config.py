...
class McpConfig:
    ...
    @staticmethod
    def get_playwrite_workbench():
        """Get playwrite MCP workbench instance"""
        playwrite_server_params = StdioServerParams(
            command="npx",
            args=[
                "@playwright/mcp@latest"
            ]
        )
        return McpWorkbench(server_params=playwrite_server_params)
